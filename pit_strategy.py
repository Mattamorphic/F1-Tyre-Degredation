...
if __name__ == "__main__":
    ...
    your graphs against the ones above (50%)
    '''
    ...
    grapher.compareGraphStrategy(
        ...
        CalulateStrategyWith.Annealing(
            Car.mercedes(track, Tyre.softTyre(), [20, 40], [Tyre.softTyre(), Tyre.mediumTyre()])
        ),
        CalulateStrategyWith.Annealing(
            Car.ferrari(track, Tyre.softTyre(), [20, 40], [Tyre.softTyre(), Tyre.mediumTyre()])
        ),
        CalulateStrategyWith.Annealing(
            Car.redbull(track, Tyre.softTyre(), [20, 40], [Tyre.softTyre(), Tyre.mediumTyre()])
        )
    )
    grapher.compareGraphStrategy(
    ...
    grapher.compareGraphStrategy(
        ...
        CalulateStrategyWith.Annealing(
            Car.mercedes(track, Tyre.hardTyre(), [30, 45], [Tyre.softTyre(), Tyre.softTyre()])
        ),
        CalulateStrategyWith.Annealing(
            Car.ferrari(track, Tyre.softTyre(), [20], [Tyre.hardTyre()])
        ),
